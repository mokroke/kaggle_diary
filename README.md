...
## 20211101
なんか10月って30日で終わりのように見えるけど、31日まであるから。31日はやらなかっただけだから。  
画像分析もちょっとやろうと思ってめちゃくちゃ初歩で動かした。data_loaderをセットするだけなのにめちゃくちゃ時間かかるのはなんでなんだろう。  
犬猫分析のときは全然時間かからなかったのに。 不思議。まだまだ全然知らないことがたくさんあるなぁ。もっと精進していこう。

## 20211102
なぜかやる気というか悟りに入った気がする。何もやろうと思えない。でも、昨日設定したkaggleのnotebookは調整した。
これで結果がちょっと出て欲しい

## 20211103
notebookを実行してて、submitを出せるようになった！実行して保存できるようにしたら一番下の方にDataがあって、そこからsubmitすることができる。
これでようやく提出までの道のりが見えてきた。どんどん改善していこう。

## 20211104
googlebrainのやつsingleでtransformerしてgoldメダル取ってる人いる。マジですごいな。  
途中から全然参加できてなかったけど、上の方の精度が怖いくらい上がってた。MAEで0.05とか行くのヤバすぎでしょ。復習しよ。

## 20211106
かぐるべんきょーかいの資料を読んだ。重力波の検出で信号処理を使うとかいうちょっとよくわからないやつだった。だけど、信号データ、時系列データを画像にする処理だったり、画像にしてからはCNNを使っていたりして、ちょっとだけ親近感が湧いた。  
あと、今回のgooglebrainで銅メダルを取った人の解き方を見せてもらった。LSTMを使ってクラスタリング使って、特徴量を作成したらできたみたいな感じだった。自分もそれくらいできるようになりたいなと思った。  

## 20211107
google brainの3rdのチームの解法を見たけど、まずvalidationの方法を考え、featureを考え、argumantationをして、lossについて考え、enseambleしたって感じだった。なんか見た感じすごく綺麗で見やすかった。考えが整理されていて、一つ一つデータに向き合っていたのだということが伝わってきた。シンプルでもいける。しっかりとデータと向き合って、discussion,codeから学びつつ、理解を深めていくのが大事なんだなと思った。trustCVっていう概念も、ただcvを信じるってだけじゃなくて、信頼できるcvをしっかり作って、信頼していくってことなんだなっておもった。それを考えた上でまた少しずつデータに向き合ってみたいなって思う。

## 20211111
ただいま。4日ぶりに書きました。これからも引き続きやっていきたいと思います。  
今日は乳がんの組織病理画像分類のコンペの解法を読んでいた。最近はcodeを読むためにクラスについて少し勉強していた。自分でもクラスをちょっとずつ作るようになっていてちょっとずつ見方がわかってきたかもしれない。クラスを作る際に考えることは、元々は一行ごとの処理の長いリストだってこと。だけど長かったり同じ処理だからまとめる。データを保存したり、同じ処理をまとめたりするのがクラス。だから、最初から全てのクラスを見てから理解しようとするんじゃなくて、一番最後の大きな動きからわからないところ、つまり自作している関数やクラスを見ていけばいいんじゃないかなって思った。そんな感じでこれからも読んでいこうと思う。
